...
- **[reference-matrix]** FOR loop syntax and variable forms: corpus syntax/w036-for-f-usebackq-command-valid does not assert any of ['E010', 'E020', 'E040', 'W036', 'W038', 'W059']
- **[reference-matrix]** CALL subroutine and GOTO EOF colon rules: corpus integration/s010-goto-after-if-valid does not assert any of ['E012', 'E014', 'E015', 'S010', 'W057']
- **[reference-matrix]** CALL subroutine and GOTO EOF colon rules: corpus integration/sec016-restart-no-limit does not assert any of ['E012', 'E014', 'E015', 'S010', 'W057']
...
- **[reference-matrix]** SETLOCAL/ENDLOCAL pairing and nesting limit: corpus integration/p024-setlocal-in-comment-valid does not assert any of ['P005', 'P006', 'P027']
...
- **[reference-matrix]** Redundant existence checks and code duplication: corpus integration/p024-setlocal-in-comment-valid does not assert any of ['P001', 'P002', 'P017', 'P024']
