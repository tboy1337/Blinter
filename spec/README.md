...
235-case conformance corpus. The **batch language** SSOT lives in the pinned
...
The pinned release is recorded in [`batch-spec.lock`](batch-spec.lock) (currently `v0.70.0`).
