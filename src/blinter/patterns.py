...
POWERSHELL_PATTERNS: List[str] = [
    ...
    r"-gt\s+",
    r"-lt\s+",
    r"(?<![\w.\\/:])Get-[\w-]+(?![\w-])(?!\.(?:bat|cmd|exe|com|ps1|psm1|psd1|ps1xml|vbs)\b)",
    r"(?<![\w.\\/:])Set-[\w-]+(?![\w-])(?!\.(?:bat|cmd|exe|com|ps1|psm1|psd1|ps1xml|vbs)\b)",
    r"(?<![\w.\\/:])Write-[\w-]+(?![\w-])(?!\.(?:bat|cmd|exe|com|ps1|psm1|psd1|ps1xml|vbs)\b)",
    r"(?<![\w.\\/:])New-[\w-]+(?![\w-])(?!\.(?:bat|cmd|exe|com|ps1|psm1|psd1|ps1xml|vbs)\b)",
    r"foreach\s*\(",
    r"(?<![\w.\\/:])ForEach-Object(?![\w-])(?!\.(?:bat|cmd|exe|com|ps1|psm1|psd1|ps1xml|vbs)\b)",
    r"\|\s*%\s*{",
    r"\.Get\(\)",
    r"\.OpenSubKey\(",
    r"\.GetSubKeyNames\(\)",
